...
import { Mail, Lock, Eye, EyeOff, LogIn, AlertCircle, CheckCircle, Shield, User, MapPin, Users, Info, Building, Home, Map } from "lucide-react";
...
const LoginPage = () => {
  ...
  const demoCredentials = {
    admin_kabupaten: {
      email: "kabupaten@infokanmas.id",
      password: "kabupaten123",
    },
    admin_kecamatan: {
      email: "kecamatan@infokanmas.id", 
      password: "kecamatan123",
    },
    admin_desa: { 
      email: "desa@infokanmas.id", 
      password: "desa123" 
    },
    masyarakat: {
  ...
  const roleOptions = [
    ...
    },
    {
      ...
      label: "Admin Dinas",
      icon: Users,
      description: "Kelola program dan anggaran dinas",
                ...
                <div className="mb-12 flex items-center justify-center gap-3">
                  <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/30">
                    <img
                      src="/logo.png"
                      alt=""
                      className="h-10 w-10 invert brightness-0 saturate-0"
                    />
                  </div>
                  <div>
                ...
                <div className="space-y-5 mb-10">
                  {features.map((feature, index) => {
                    ...
                    return (
                      <Card
                        key={index}
                        className={`p-5 rounded-2xl backdrop-blur-xl border transition-all duration-700 transform ${
                          index === activeFeature
              ...
              <CardContent className="w-full max-w-md mx-auto p-0">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">
                    Masuk sesuai peran Anda di sistem InfoKanMas
                  </p>
                </div>
                      ...
                      {roleOptions.map((option) => {
                        ...
                        return (
                          <button
                            ...
                            className={`p-4 rounded-xl border-2 transition-all flex flex-col items-center gap-3 group h-auto ${
        ...
        <DialogContent className="bg-white rounded-3xl shadow-2xl max-w-md p-7 transform animate-scale-up border-0">
          ...
          <div className="space-y-3  grid grid-cols-2 gap-3">
            {roleOptions.map((role) => (
              <Card
                key={role.value}
                className="border-2 border-gray-200 rounded-2xl p-4 hover:border-blue-300 transition-all hover:shadow-md"
              >
                <CardContent className="p-0">
                  ...
                  <div className="text-xs text-gray-600 space-y-1.5 bg-gray-50 p-3 rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-mono">
                        {demoCredentials[role.value].email}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Lock size={12} className="text-gray-400" />
                      <span className="font-mono">
                        {demoCredentials[role.value].password}
                      </span>
                    </div>
                  </div>
                </CardContent>
                <Button
                  ...
                  className="px-4 w-full py-1.5 bg-blue-600 text-white text-xs font-medium rounded-lg hover:bg-blue-700 transition-all transform hover:scale-105 active:scale-95"
                >
                  Gunakan
                </Button>
              </Card>
          ...
          <Card className="mt-5 p-4 bg-blue-50 border-2 border-blue-200 rounded-2xl">
            <CardContent className="p-0">
              <p className="text-xs text-blue-800 leading-relaxed">
                <strong>Catatan:</strong> Ini adalah kredensial demo untuk
                testing sistem InfoKanMas Purbalingga.
              </p>
            </CardContent>
          </Card>
        </DialogContent>
