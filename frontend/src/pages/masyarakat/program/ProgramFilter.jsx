...
const ProgramFilter = ({ filters, setFilters }) => {
  ...
  const hasActiveFilters = filters.jenis !== 'semua' || filters.status !== 'semua';
        ...
        <>
          ...
          <div className="absolute right-0 top-full mt-2 z-50 bg-white rounded-2xl shadow-lg border border-gray-200 p-4 w-64">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-gray-800">Filter Program</h3>
              <button
                onClick={() => setShowFilter(false)}
