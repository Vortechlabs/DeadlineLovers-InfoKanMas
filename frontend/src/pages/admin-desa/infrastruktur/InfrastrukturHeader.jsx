...
import { Building, Plus, Download, Map } from 'lucide-react';

const InfrastrukturHeader = ({ totalProjects, onAddProject, onExportReport }) => {
  return (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Kelola proyek infrastruktur dan pembangunan fisik desa
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <button 
            ...
            className="px-4 py-2 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-lg text-sm font-medium hover:from-orange-600 hover:to-red-700 transition-all shadow-lg shadow-orange-500/25 flex items-center gap-2"
          >
            <Plus size={16} />
            Proyek Baru
          </button>
...
export default InfrastrukturHeader;